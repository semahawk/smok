...
return array(
	...
	'module_event_hooks'=>array(
		...
		'event_chance'=>array(
			'name'=>'event_chance', 'type'=>'varchar(255)'
			),
	...
	'module_navhooks'=>array(
		'modulename'=>array(
			'name'=>'modulename', 'type'=>'varchar(50)'
			),
		'page'=>array(
			'name'=>'page', 'type'=>'varchar(255)'
			),
		'display'=>array(
			'name'=>'display', 'type'=>'varchar(50)'
			),
		'link'=>array(
			'name'=>'link', 'type'=>'varchar(255)'
			),
		'hookorder'=>array(
			'name'=>'hookorder', 'type'=>'tinyint(4)', 'default'=>'0'
			),
		'key-PRIMARY'=>array(
			'name'=>'PRIMARY',
			'type'=>'primary key',
			'unique'=>'1',
			'columns'=>'modulename,page,display'
			)
		),
	...
	'module_prefdesc'=>array(
		...
		'description'=>array(
			'name'=>'description', 'type'=>'varchar(255)', 'null'=>'1'
			),
		'type'=>array(
			'name'=>'type', 'type'=>'tinyint(4)', 'default'=>'0'
			),
		'def'=>array(
			'name'=>'def', 'type'=>'varchar(255)'
			),
		'key-PRIMARY'=>array(
			'name'=>'PRIMARY',
			'type'=>'primary key',
	...
	'module_settingdesc'=>array(
		...
		'type'=>array(
			'name'=>'type', 'type'=>'tinyint(4)', 'null'=>'1'
			),
		'def'=>array(
			'name'=>'def', 'type'=>'varchar(255)'
			),

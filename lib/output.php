...
function appoencode($data,$priv=false){
	...
	if (!isset($nestedtags['>'])) $nestedtags['>']=false;
	if (!isset($nestedtags['t'])) $nestedtags['t']=false;

	while( ($x=strpos($data,"`")) !== false ){
		$tag=substr($data,$x+1,1);
		$append=substr($data,0,$x);
		$out.=($priv?$append:HTMLEntities($append, ENT_COMPAT, getsetting("charset", "ISO-8859-1")));
		switch($tag){
		case "0":
		...
		case "1":
			...
			$out.="<span class='colDkBlue'>";
			break;
		case "2":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkGreen'>";
			break;
		case "3":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkCyan'>";
			break;
		case "4":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkRed'>";
			break;
		case "5":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkMagenta'>";
			break;
		case "6":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkYellow'>";
			break;
		case "7":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkWhite'>";
			break;
		case "!":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtBlue'>";
			break;
		case "@":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtGreen'>";
			break;
		case "#":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtCyan'>";
			break;
		case "$":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtRed'>";
			break;
		case "%":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtMagenta'>";
			break;
		case "^":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtYellow'>";
			break;
		case "&":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
		...
		case "q":
			...
			$out.="<span class='colDkOrange'>";
			break;
		case "Q":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtOrange'>";
			break;
		case ")":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtBlack'>";
			break;
		case "c":
			if ($nestedtags['div']) {
				$out.="</div>";
		...
		case "R":
			...
			$out.="<span class='colRose'>";
			break;
		case "V":
			if ($nestedtags[font]) $out.="</span>";
			else $nestedtags[font]=true;
			$out.="<span class='colBlueViolet'>";
			break;
		case "v":
			if ($nestedtags[font]) $out.="</span>";
			else $nestedtags[font]=true;
			$out.="<span class='coliceviolet'>";
			break;
		case "g":
		case "G":
			if ($nestedtags[font]) $out.="</span>";
			else $nestedtags[font]=true;
			$out.="<span class='colXLtGreen'>";
			break;
		case "T":
			if ($nestedtags[font]) $out.="</span>";
			else $nestedtags[font]=true;
			$out.="<span class='colDkBrown'>";
			break;
		case "t":
			if ($nestedtags[font]) $out.="</span>";
			else $nestedtags[font]=true;
			$out.="<span class='colLtBrown'>";
			break;
		case "~":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colBlack'>";
			break;
		case "e":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkRust'>";
			break;
		case "E":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtRust'>";
			break;
		case "j":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colMdGrey'>";
			break;
		case "J":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colMdBlue'>";
			break;
		case "l":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colDkLinkBlue'>";
			break;
		case "L":
			if ($nestedtags['font']) $out.="</span>";
			else $nestedtags['font']=true;
			$out.="<span class='colLtLinkBlue'>";
			break;
		case "c":
			if ($nestedtags['div']) {
				$out.="</div>";
	...
	if ($priv){
		...
		$out.=HTMLEntities($data, ENT_COMPAT, getsetting("charset", "ISO-8859-1"));
	}
	return $out;
}
 ...
 */
function addnavheader($text, $collapse=true)
{
	global $navsection,$navbysection,$translation_namespace;
	global $navschema,$navnocollapse, $block_new_navs;
...
function private_addnav($text,$link=false,$priv=false,$pop=false,$popsize="500x300"){
	...
	global $nav,$session,$accesskeys,$REQUEST_URI,$quickkeys,$navschema;
	...
	if (is_array($text)){
		...
		if ($text && $session['loggedin']) {
			tlschema($navschema[$text]);
			$unschema = 1;
		}
		if ($link != "!!!addraw!!!" && $text>"") $text = translate($text);
	}
	...
	if ($link===false){
		...
		if ($text!=""){
			...
			if (substr($text,1,1)=="?") {
				...
				$hchar = strtolower(substr($text, 0, 1));

...
if ($op=="lasthit"){
	$output="";
	$sql = "SELECT output FROM " . db_prefix("accounts") . " WHERE acctid='$userid'";
	$result = db_query($sql);
...
#		$sql = "UPDATE " . db_prefix("accounts") . " SET lasthit='$newdate' WHERE acctid='$userid'";
		...
		$sql = "UPDATE " . db_prefix("accounts") . " SET allowednavs='',output='', restorepage='', specialinc='' WHERE acctid='$userid'";
		db_query($sql);

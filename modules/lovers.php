...
function lovers_chat_violet(){
	...
	if (httpget('act')==""){
		...
		output("After a few minutes, Cedrik begins to cast burning looks your way, and you decide you had best let %s`0 get back to work.", getsetting("barmaid", "`%Violet"));

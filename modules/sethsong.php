...
function sethsong_sing()
{
	...
	case 2:
		...
		break;
	case 3:
		output("Gather 'round and I'll tell you a tale`nmost terrible and dark`nof Cedrik and his unclean beer`nand how he hates this bard!`n`n");
		output("`0You realize he's right, Cedrik's beer really is nasty.");
	...
	case 6:
		...
		break;
	case 7:
		output("`0Seth seems to sit up and prepare himself for something impressive.");
